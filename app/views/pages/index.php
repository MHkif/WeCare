    ...
    <form class="mx-72 w-full">
        <div class="flex">
            ...
            <div class="relative w-full">
                <input type="search" id="search-dropdown" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-r border-l-green-300 border-l-2 border border-green-300 focus:ring-green-200 focus:border-green-200  " placeholder="Search" required>
...
<!-- Santé -->
<section id="sante" class="my-10 mx-6  py-6 px-6 md:px-8 md:py-8 rounded-lg  md:mx-8 md:my-14 bg-gray-50 bg-opacity-75" style="font-family: 'Poppins';">
<h1 class="max-w-md text-1xl font-bold text-center mb-6 md:text-3xl md:text-left md:mb-8">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 items-start  md:grid-cols-3 lg:grid-cols-4">
        <!-- Items -->
        <div class="w-full bg-white border border-gray-200 rounded-md shadow-md dark:bg-gray-800 dark:border-gray-700">

            <div class="h-60 flex items-center justify-center">
                <img class="w-44  h-52 rounded-t-md sm:max-h-56" src="./src/arkorelax.jpg" alt="" />

            </div>
            <div class="p-3 flex flex-col gap-4 md:gap-6 md:p-5">

                <h5 class="text-md tracking-tight font-bold text-gray-900 dark:text-white ">Arkorelax Sommeil Fort 8h Comprimés B/15</h5>
        ...
        <div class="w-full bg-white border border-gray-200 rounded-md shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="h-60 flex items-center justify-center">
                <img class="w-44  h-52 rounded-t-md sm:max-h-56" src="./src/govital.png" alt="" />

            </div>
            <div class="p-3 flex flex-col gap-4 md:gap-6 md:p-5">

                <h5 class="text-md tracking-tight font-bold text-gray-900 dark:text-white">Biotin & Multivitamin for hair growth</h5>
        ...
        <div class="w-full bg-white border border-gray-200 rounded-md shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="h-60 flex items-center justify-center">
                <img class="w-44  h-52 rounded-t-md sm:max-h-56" src="./src/acerol.jpg" alt="" />

            </div>
            <div class="p-3 flex flex-col gap-4 md:gap-6 md:p-5">

                <h5 class="text-md tracking-tight font-bold text-gray-900 dark:text-white ">Acerol C Vitamine C Naturelle Comprimés Pot/60</h5>
        ...
        <div class="w-full bg-white border border-gray-200 rounded-md shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="h-60 flex items-center justify-center">
                <img class="w-44  h-52 rounded-t-md sm:max-h-56" src="./src/berocca.jpg" alt="" />

            </div>
            <div class="p-3 flex flex-col gap-4 md:gap-6 md:p-5">

                <h5 class="text-md tracking-tight font-bold text-gray-900 dark:text-white">Berocca Energie Comprimés Effervescents Orange B/30</h5>
...
<section id="douleur-fievre" class=" my-10 mx-6  py-6 px-6 md:px-8 md:py-8 rounded-lg  md:mx-8 md:my-14 bg-gray-50 bg-opacity-75" style="font-family: 'Poppins';">
    <h1 class="max-w-md text-1xl font-bold text-center mb-6 md:text-3xl md:text-left md:mb-8">
        Douleurs & Fièvre
    </h1>
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 items-start  md:grid-cols-3 lg:grid-cols-4">
